...
from utils.search_power import build_undermine_conditions
from utils.search_any import build_any_material_query

def search(display_format='full'):
    """Search for undermining targets
    Args:
    ...
    try:
        ...
        power_conditions = build_undermine_conditions(params['controlling_power'], opposing_power)
        if power_conditions:
